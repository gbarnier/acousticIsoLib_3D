...
__global__ void scaleReflectivityTauSlowSquare_3D(double *dev_modelExtIn, double *dev_vel2Dtw2In, long long extStrideIn){
...
__global__ void scaleReflectivityLinHxHySlowSquare_3D(double *dev_modelExtIn, long long extStride1In, long long extStride2In){
...
__global__ void interpFineToCoarseSlice_32_3D(double *dev_timeSliceLeft, double *dev_timeSliceRight, double *dev_timeSliceFine, int it2) {
...
__global__ void srcWfldSecondTimeDerivative_32_3D(double *dev_wavefieldSlice, double *dev_slice0, double *dev_slice1, double *dev_slice2) {
...
__global__ void dampCosineEdge_32_3D(double *dev_p1, double *dev_p2) {
...
__global__ void dampCosineEdgeFreeSurface_32_3D(double *dev_p1, double *dev_p2) {
