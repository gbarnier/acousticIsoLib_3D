...
void computeTomoLeg1HxHyAdj_3D(double *dev_modelTomoIn, double *wavefield1, double *wavefield2, double *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, int nBlockDataIn, double *dev_dataRegDtsQcIn);

void computeTomoLeg2HxHyAdj_3D(double *dev_modelTomoIn, double *wavefield1, double *wavefield2, double *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, int nBlockDataIn, double *dev_dataRegDtsQcIn);

// Adjoint + Time-lags
void computeTomoLeg1TauAdj_3D(double *dev_modelTomoIn, double *wavefield1, double *wavefield2, double *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, int nBlockDataIn, double *dev_dataRegDtsQcIn);
...
/******************************* Free surface *********************************/
void computeTomoFsSrcWfldDt2_3D(double *dev_sourcesIn, double *wavefield1, long long *dev_sourcesPositionsRegIn, int nSourcesRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGridFsIn, dim3 dimBlockFsIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamIn);

void computeTomoFsRecWfld_3D(double *dev_dataRegDtsIn, double *wavefield2, long long *dev_receiversPositionsRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGridFsIn, dim3 dimBlockFsIn, int nblockDataIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamIn);

// Forward + Subsurface offsets
void computeTomoFsLeg1HxHyFwd_3D(double *dev_modelTomoIn, double *wavefield1, double *wavefield2, double *dev_dataRegDtsIn, double *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGridFsIn, dim3 dimBlockFsIn, int nblockDataIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, cudaStream_t transferStreamD2HIn);

void computeTomoFsLeg2HxHyFwd_3D(double *dev_modelTomoIn, double *wavefield1, double *wavefield2, double *dev_dataRegDtsIn, double *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGridFsIn, dim3 dimBlockFsIn, int nblockDataIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, cudaStream_t transferStreamD2HIn);

// Forward + Time-lags
void computeTomoFsLeg1TauFwd_3D(double *dev_modelTomoIn, double *wavefield1, double *wavefield2, double *dev_dataRegDtsIn, double *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGridFsIn, dim3 dimBlockFsIn, int nblockDataIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, cudaStream_t transferStreamD2HIn);

void computeTomoFsLeg2TauFwd_3D(double *dev_modelTomoIn, double *wavefield1, double *wavefield2, double *dev_dataRegDtsIn, double *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGridFsIn, dim3 dimBlockFsIn, int nblockDataIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, cudaStream_t transferStreamD2HIn);

// Adjoint + Subsurface offsets
void computeTomoFsLeg1HxHyAdj_3D(double *dev_modelTomoIn, double *wavefield1, double *wavefield2, double *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGridFsIn, dim3 dimBlockFsIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, int nBlockDataIn, double *dev_dataRegDtsQcIn);

void computeTomoFsLeg2HxHyAdj_3D(double *dev_modelTomoIn, double *wavefield1, double *wavefield2, double *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGridFsIn, dim3 dimBlockFsIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, int nBlockDataIn, double *dev_dataRegDtsQcIn);

// Adjoint + Time-lags
void computeTomoFsLeg1TauAdj_3D(double *dev_modelTomoIn, double *wavefield1, double *wavefield2, double *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGridFsIn, dim3 dimBlockFsIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, int nBlockDataIn, double *dev_dataRegDtsQcIn);

void computeTomoFsLeg2TauAdj_3D(double *dev_modelTomoIn, double *wavefield1, double *wavefield2, double *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGridFsIn, dim3 dimBlockFsIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, int nBlockDataIn, double *dev_dataRegDtsQcIn);
...
void allocateSetTomoExtGinsuGpu_3D(int nz, int nx, int ny, int minPad, int blockSize, double alphaCos, double *vel2Dtw2, double *reflectivityScale, int iGpu, int iGpuId){
	...
	// Allocate time slices on device for the FD stepping
	cuda_call(cudaMalloc((void**) &dev_pDt0[iGpu], host_nVel_ginsu[iGpu]*sizeof(double)));
	cuda_call(cudaMalloc((void**) &dev_pDt1[iGpu], host_nVel_ginsu[iGpu]*sizeof(double)));
	cuda_call(cudaMalloc((void**) &dev_pDt2[iGpu], host_nVel_ginsu[iGpu]*sizeof(double)));
	...
	cuda_call(cudaMalloc((void**) &dev_pRecWavefield[iGpu], host_nVel_ginsu[iGpu]*sizeof(double)));

	// Allocate and copy from host to device extended reflectivity
	cuda_call(cudaMalloc((void**) &dev_extReflectivity[iGpu], host_nModelExt_ginsu[iGpu]*sizeof(double)));
...
void tomoHxHyShotsFwdGpu_3D(double *model, double *dataRegDts, double *extReflectivity, double *sourcesSignals, long long *sourcesPositionReg, int nSourcesReg, long long *receiversPositionReg, int nReceiversReg, double *wavefield1, double *wavefield2, int iGpu, int iGpuId){
	...
	// double *dummyData, *dummyModel, *dummyReflectivity;
	// dummyData = new double[nReceiversReg*host_nts];
	// dummyModel = new double[host_nVel];
	// dummyReflectivity = new double[host_nModelExt];
	// cuda_call(cudaMemcpy(dummyReflectivity, dev_extReflectivity[iGpu], host_nModelExt*sizeof(double), cudaMemcpyDeviceToHost));
	...
	if (host_leg1 == 1){
		...
		// cuda_call(cudaMemcpy(dummyModel, dev_modelTomo[iGpu], host_nVel*sizeof(double), cudaMemcpyDeviceToHost));
		...
		// cuda_call(cudaMemcpy(dummyData, dev_dataRegDts[iGpu], nReceiversReg*host_nts*sizeof(double), cudaMemcpyDeviceToHost));
...
// Subsurface offsets + free surface
void tomoHxHyFsShotsAdjGpu_3D(double *model, double *dataRegDts, double *extReflectivity, double *sourcesSignals, long long *sourcesPositionReg, int nSourcesReg, long long *receiversPositionReg, int nReceiversReg, double *wavefield1, double *wavefield2, int iGpu, int iGpuId, double *dataRegDtsQc){
...
// Time-lags + free surface
void tomoTauFsShotsAdjGpu_3D(double *model, double *dataRegDts, double *extReflectivity, double *sourcesSignals, long long *sourcesPositionReg, int nSourcesReg, long long *receiversPositionReg, int nReceiversReg, double *wavefield1, double *wavefield2, int iGpu, int iGpuId, double *dataRegDtsQc){
...
void computeTomoSrcWfldDt2_3D(double *dev_sourcesIn, double *wavefield1, long long *dev_sourcesPositionsRegIn, int nSourcesRegIn, dim3 dimGridIn, dim3 dimBlockIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamIn){
	...
	for (int its = 1; its < host_nts-1; its++){
		...
		// cuda_call(cudaMemcpy(dummySliceRight, pin_wavefieldSlice1[iGpu], host_nVel*sizeof(double), cudaMemcpyDeviceToHost));
	...
	cuda_call(cudaMemcpy(dev_pDt2[iGpu], dev_pLeft[iGpu], host_nVel*sizeof(double), cudaMemcpyDeviceToDevice, compStreamIn));
...
void computeTomoLeg1HxHyFwd_3D(double *dev_modelTomoIn, double *wavefield1, double *wavefield2, double *dev_dataRegDtsIn, double *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, int nBlockDataIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, cudaStream_t transferStreamD2HIn){
	...
	double *dummySliceLeft, *dummySliceRight, *dummyRef;
	dummySliceLeft = new double[host_nVel];
	dummySliceRight = new double[host_nVel];
	dummyRef = new double[host_nModelExt];
	...
	// cuda_call(cudaMemcpy(dummyRef, dev_extReflectivityIn, host_nModelExt*sizeof(double), cudaMemcpyDeviceToHost));
...
void computeTomoLeg1TauFwd_3D(double *dev_modelTomoIn, double *wavefield1, double *wavefield2, double *dev_dataRegDtsIn, double *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, int nBlockDataIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, cudaStream_t transferStreamD2HIn){
	...
	for (int iExt=0; iExt<4*host_hExt1+1; iExt++){
		...
		if (iExt < 2*host_hExt1+1){
			...
			std::memcpy(pin_wavefieldSlice1[iGpu], wavefield1+iExt*host_nVel, host_nVel*sizeof(double));
	...
	std::memcpy(pin_wavefieldSlice1[iGpu], wavefield1+(2*host_hExt1+1)*host_nVel, host_nVel*sizeof(double));
	...
	for (int its = 0; its < host_nts-1; its++){
		...
		if (its < 2*host_hExt1-1) {
			...
			cuda_call(cudaMemcpyAsync(pin_wavefieldSlice1[iGpu], wavefield1+(its+2*host_hExt1+2)*host_nVel, host_nVel*sizeof(double), cudaMemcpyHostToHost, transferStreamH2DIn));
...
void computeTomoLeg2TauFwd_3D(double *dev_modelTomoIn, double *wavefield1, double *wavefield2, double *dev_dataRegDtsIn, double *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, int nBlockDataIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, cudaStream_t transferStreamD2HIn){
	...
	for (int its = 0; its < host_nts-1; its++){
		...
		if (its < host_nts-2){
			cuda_call(cudaMemcpyAsync(pin_wavefieldSlice1[iGpu], wavefield1+(its+2)*host_nVel, host_nVel*sizeof(double), cudaMemcpyHostToHost, transferStreamH2DIn));
			cuda_call(cudaStreamSynchronize(compStreamIn));
			cuda_call(cudaMemcpyAsync(dev_pStream[iGpu], pin_wavefieldSlice1[iGpu], host_nVel*sizeof(double), cudaMemcpyHostToDevice, transferStreamH2DIn));
		}
	...
	for (int iExt=0; iExt<4*host_hExt1+1; iExt++){
		...
		if (iExt < 2*host_hExt1+1){
			...
			// Copy slice from RAM -> pinned
			std::memcpy(pin_wavefieldSlice1[iGpu], wavefield2+iExt*host_nVel, host_nVel*sizeof(double));
	...
	// Transfer slice 2*host_hExt1+1 from RAM to pinned
	std::memcpy(pin_wavefieldSlice1[iGpu], wavefield2+(2*host_hExt1+1)*host_nVel, host_nVel*sizeof(double));
	...
	for (int its = 0; its < host_nts-1; its++){
		...
		if (its < 2*host_hExt1-1) {
			...
			cuda_call(cudaMemcpyAsync(pin_wavefieldSlice1[iGpu], wavefield2+(its+2*host_hExt1+2)*host_nVel, host_nVel*sizeof(double), cudaMemcpyHostToHost, transferStreamH2DIn));
...
void computeTomoLeg1TauAdj_3D(double *dev_modelTomoIn, double *wavefield1, double *wavefield2, double *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, int nBlockDataIn, double *dev_dataRegDtsQcIn){
	...
	for (int its = 0; its < host_nts-1; its++){
		...
		// Copy receiver wavefield value at its from pDt0 -> pRecWavefield
		cuda_call(cudaMemcpyAsync(dev_pRecWavefield[iGpu], dev_pDt0[iGpu], host_nVel*sizeof(double), cudaMemcpyDeviceToDevice, compStreamIn));
		// cuda_call(cudaMemcpy(dev_pRecWavefield[iGpu], dev_pDt0[iGpu], host_nVel*sizeof(double), cudaMemcpyDeviceToDevice));
		...
		// std::memcpy(pin_wavefieldSlice2[iGpu], wavefield2+its*host_nVel, host_nVel*sizeof(double));
		// cuda_call(cudaMemcpy(dev_pDt0[iGpu], pin_wavefieldSlice2[iGpu], host_nVel*sizeof(double), cudaMemcpyHostToDevice));
		// cuda_call(cudaMemcpy(dev_pRecWavefield[iGpu], dev_pDt0[iGpu], host_nVel*sizeof(double), cudaMemcpyDeviceToDevice));
...
// Receiver wavefield
void computeTomoFsRecWfld_3D(double *dev_dataRegDtsIn, double *wavefield2, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGridFsIn, dim3 dimBlockFsIn, int nBlockDataIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamIn){
