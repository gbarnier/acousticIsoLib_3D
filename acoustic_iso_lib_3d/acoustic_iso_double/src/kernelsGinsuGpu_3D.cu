...
__global__ void scaleReflectivityTauGinsuSlowSquare_3D(double *dev_modelExtIn, double *dev_vel2Dtw2In, long long extStrideIn, int iGpu){
...
__global__ void scaleReflectivityLinHxHyGinsuSlowSquare_3D(double *dev_modelExtIn, long long extStride1In, long long extStride2In, int iGpu){
