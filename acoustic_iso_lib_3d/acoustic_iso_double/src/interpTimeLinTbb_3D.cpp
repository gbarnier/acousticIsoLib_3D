...
interpTimeLinTbb_3D::interpTimeLinTbb_3D(int nts, double dts, double ots, int sub) {
...
void interpTimeLinTbb_3D::forward(const bool add, const std::shared_ptr<double2DReg> model, std::shared_ptr<double2DReg> data) const {
...
void interpTimeLinTbb_3D::adjoint(const bool add, std::shared_ptr<double2DReg> model, const std::shared_ptr<double2DReg> data) const {
