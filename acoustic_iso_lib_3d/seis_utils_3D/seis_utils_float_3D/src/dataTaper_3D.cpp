...
// Comments
// Remove the streamer option

// Constructor for both time and offset
dataTaper_3D::dataTaper_3D(float t0, float velMute, float expTime, float taperWidthTime, std::string moveout, int reverseTime, float maxOffset, float expOffset, float taperWidthOffset, int reverseOffset, std::shared_ptr<SEP::hypercube> dataHyper, float taperEndTraceWidth, int streamers){
...
dataTaper_3D::dataTaper_3D(std::shared_ptr<SEP::hypercube> dataHyper, float taperEndTraceWidth){
...
dataTaper_3D::dataTaper_3D(float t0, float velMute, float expTime, float taperWidthTime, std::shared_ptr<SEP::hypercube> dataHyper, std::string moveout, int reverseTime, float taperEndTraceWidth){
...
dataTaper_3D::dataTaper_3D(float maxOffset, float expOffset, float taperWidthOffset, std::shared_ptr<SEP::hypercube> dataHyper, int reverseOffset, float taperEndTraceWidth, int streamers){
...
void dataTaper_3D::computeTaperMaskOffsetStreamers(){
