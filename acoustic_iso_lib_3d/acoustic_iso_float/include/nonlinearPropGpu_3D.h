...
class nonlinearPropGpu_3D : public seismicOperator_3D<SEP::float2DReg, SEP::float2DReg> {

	public:

		/* Overloaded constructors */
		nonlinearPropGpu_3D(std::shared_ptr<SEP::float3DReg> vel, std::shared_ptr<paramObj> par, int nGpu, int iGpu, int iGpuId, int iGpuAlloc);
		...
		/* QC */
		bool checkParfileConsistency_3D(const std::shared_ptr<SEP::float2DReg> model, const std::shared_ptr<SEP::float2DReg> data) const;
