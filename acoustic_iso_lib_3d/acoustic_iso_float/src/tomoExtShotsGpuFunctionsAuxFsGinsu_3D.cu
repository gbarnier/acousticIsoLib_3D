...
void computeTomoSrcWfldDt2FsGinsu_3D(float *dev_sourcesIn, long long *dev_sourcesPositionsRegIn, int nSourcesRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGrid32In, dim3 dimBlock32In, dim3 dimGridFreeSurfaceIn, dim3 dimBlockFreeSurfaceIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamIn){
...
// Receiver wavefield
void computeTomoRecWfldFsGinsu_3D(float *dev_dataRegDtsIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGrid32In, dim3 dimBlock32In, int nBlockDataIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamIn){
...
void computeTomoLeg2TauFwdFsGinsu_3D(float *dev_modelTomoIn, float *dev_dataRegDtsIn, float *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGrid32In, dim3 dimBlock32In, dim3 dimGridFreeSurfaceIn, dim3 dimBlockFreeSurfaceIn, int nBlockDataIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, cudaStream_t transferStreamD2HIn){
...
/************************** Forward - Offsets *********************************/
// Source -> reflectivity -> model -> data
void computeTomoLeg1HxHyFwdFsGinsu_3D(float *dev_modelTomoIn, float *dev_dataRegDtsIn, float *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGrid32In, dim3 dimBlock32In, dim3 dimGridFreeSurfaceIn, dim3 dimBlockFreeSurfaceIn, int nBlockDataIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, cudaStream_t transferStreamD2HIn){
...
// Source -> model -> reflectivity -> data
void computeTomoLeg2HxHyFwdFsGinsu_3D(float *dev_modelTomoIn, float *dev_dataRegDtsIn, float *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGrid32In, dim3 dimBlock32In, dim3 dimGridFreeSurfaceIn, dim3 dimBlockFreeSurfaceIn, int nBlockDataIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, cudaStream_t transferStreamD2HIn){
...
// Source -> model <- reflectivity <- data
void computeTomoLeg2TauAdjFsGinsu_3D(float *dev_modelTomoIn, float *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGrid32In, dim3 dimBlock32In, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, int nBlockDataIn){
	...
	for (int its = host_nts-2; its > -1; its--){
		...
		if (its > host_nts-2*host_hExt1-1){
			...
			cuda_call(cudaMemcpy(dev_pStream[iGpu], pin_wavefieldSlice2[iGpu]+(its-2*host_hExt1-1)*host_nVel_ginsu[iGpu], host_nVel_ginsu[iGpu]*sizeof(float), cudaMemcpyHostToDevice));
		...
		// Middle part of adjoint propagation
			...
			// Copy slice its-2*host_hExt-1 from pinned -> device
			// cuda_call(cudaMemcpyAsync(dev_pStream[iGpu], pin_wavefieldSlice1[iGpu], host_nVel_ginsu[iGpu]*sizeof(float), cudaMemcpyHostToDevice, transferStreamH2DIn));
			cuda_call(cudaMemcpy(dev_pStream[iGpu], pin_wavefieldSlice2[iGpu]+(its-2*host_hExt1-1)*host_nVel_ginsu[iGpu], host_nVel_ginsu[iGpu]*sizeof(float), cudaMemcpyHostToDevice));
		...
		cuda_call(cudaMemcpy(dev_pSourceWavefield[iGpu], pin_wavefieldSlice1[iGpu]+(its+1)*host_nVel_ginsu[iGpu], host_nVel_ginsu[iGpu]*sizeof(float), cudaMemcpyHostToDevice));
		// cuda_call(cudaMemcpy(dev_pSourceWavefield[iGpu], dev_pDt0[iGpu], host_nVel_ginsu[iGpu]*sizeof(float), cudaMemcpyDeviceToDevice));
		...
		if (its > host_nts-2*host_hExt1-1) {
			...
			cuda_call(cudaMemcpy(dev_pSourceWavefieldTau[iGpu][iSlice], dev_pStream[iGpu], host_nVel_ginsu[iGpu]*sizeof(float), cudaMemcpyDeviceToDevice));
		...
		// Middle part of adjoint propagation
			...
			// Copy pStream -> device
			// cuda_call(cudaMemcpyAsync(dev_pSourceWavefieldTau[iGpu][0], dev_pStream[iGpu], host_nVel_ginsu[iGpu]*sizeof(float), cudaMemcpyDeviceToDevice, compStreamIn));
			cuda_call(cudaMemcpy(dev_pSourceWavefieldTau[iGpu][0], dev_pStream[iGpu], host_nVel_ginsu[iGpu]*sizeof(float), cudaMemcpyDeviceToDevice));
		}
...
/************************* Adjoint - Offsets **********************************/
// Source -> reflectivity -> model <- data
void computeTomoLeg1HxHyAdjFsGinsu_3D(float *dev_modelTomoIn, float *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGrid32In, dim3 dimBlock32In, dim3 dimGridFreeSurfaceIn, dim3 dimBlockFreeSurfaceIn, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, int nBlockDataIn){
...
// Source -> model <- reflectivity <- data
void computeTomoLeg2HxHyAdjFsGinsu_3D(float *dev_modelTomoIn, float *dev_extReflectivityIn, long long *dev_receiversPositionRegIn, dim3 dimGridIn, dim3 dimBlockIn, dim3 dimGrid32In, dim3 dimBlock32In, int iGpu, cudaStream_t compStreamIn, cudaStream_t transferStreamH2DIn, int nBlockDataIn){
