...
/*********************************** Injection ********************************/
/******************************************************************************/
__global__ void injectSecondarySourceGinsu_3D(float *dev_ssLeft, float *dev_ssRight, float *dev_p0, int indexFilter, int iGpu) {
...
__global__ void scaleReflectivityGinsu_3D(float *dev_model, float *dev_reflectivityScaleIn, float *dev_vel2Dtw2In, int iGpu) {
...
__global__ void scaleReflectivityTauGinsuSlowSquare_3D(float *dev_modelExtIn, float *dev_vel2Dtw2In, long long extStrideIn, int iGpu){
...
__global__ void scaleReflectivityLinHxHyGinsuSlowSquare_3D(float *dev_modelExtIn, long long extStride1In, long long extStride2In, int iGpu){
...
/**************************** Imaging condition *******************************/
/******************************************************************************/
__global__ void imagingFwdGinsuGpu_3D(float *dev_model, float *dev_data, float *dev_sourceWavefieldDts, int iGpu) {
...
__global__ void imagingAdjGinsuGpu_3D(float *dev_model, float *dev_data, float *dev_sourceWavefieldDts, int iGpu) {
...
// Forward time-lags
__global__ void imagingTauFwdGinsuGpu_32_3D(float *dev_model, float *dev_data, float *dev_sourceWavefieldDts, int iExt, int iGpu) {
...
__global__ void imagingTauTomoAdjGinsuGpu_3D(float *dev_model, float *dev_data, float *dev_extReflectivity, long long iExt1, int iGpu) {
...
__global__ void imagingHxHyTomoAdjGinsuGpu_3D(float *dev_model, float *dev_data, float *dev_extReflectivity, int ihx, long long iExt1, int ihy, long long iExt2, int iGpu) {
...
/******************************************************************************/
__global__ void interpFineToCoarseSliceGinsu_3D(float *dev_timeSliceLeft, float *dev_timeSliceRight, float *dev_timeSliceFine, int it2, int iGpu) {
...
__global__ void interpFineToCoarseSliceGinsu_32_3D(float *dev_timeSliceLeft, float *dev_timeSliceRight, float *dev_timeSliceFine, int it2, int iGpu) {
...
/****************************** Time derivative *******************************/
/******************************************************************************/
__global__ void srcWfldSecondTimeDerivativeGinsu_32_3D(float *dev_wavefieldSlice, float *dev_slice0, float *dev_slice1, float *dev_slice2, int iGpu){
...
/******************************** Damping *************************************/
/******************************************************************************/
__global__ void dampCosineEdgeGinsu_32_3D(float *dev_p1, float *dev_p2, int iGpu) {
	...
	if (izGlobal < dev_nz_ginsu[iGpu]-FAT && ixGlobal < dev_nx_ginsu[iGpu]-FAT){
	    ...
	    for (long long iyGlobal=FAT; iyGlobal<dev_ny_ginsu[iGpu]-FAT; iyGlobal++){
	    	...
	    	if (distToEdge < dev_minPad_ginsu[iGpu]){
	    		...
	    		// float damp = dampCosArray[distToEdge];
                float damp = dev_cosDampingCoeffGinsuConstant[iGpu][distToEdge];
...
__global__ void dampCosineEdgeFreeSurfaceGinsu_3D(float *dev_p1, float *dev_p2, int iGpu) {
...
__global__ void dampCosineEdgeFreeSurfaceGinsu_32_3D(float *dev_p1, float *dev_p2, int iGpu) {
...
/******************************* Forward stepper ******************************/
/******************************************************************************/
__global__ void stepFwdGinsuGpu_3D(float *dev_o, float *dev_c, float *dev_n, float *dev_vel2Dtw2, int iGpu){
...
__global__ void setFreeSurfaceConditionFwdGinsuGpu_3D(float *dev_c, int iGpu){
...
/******************************* Adjoint stepper ******************************/
/******************************************************************************/
__global__ void stepAdjGinsuGpu_3D(float *dev_o, float *dev_c, float *dev_n, float *dev_vel2Dtw2, int iGpu) {
    ...
    // Question: is that on the global memory? -> can it fit in the register?
    // Why do we create this temporary array and not call it directly from global memory?
    float dev_c_y[2*FAT]; // Array for the current wavefield y-slice
    float dev_vel_y[2*FAT]; // Array for the scaled velocity y-slice
...
__global__ void stepAdjFreeSurfaceGinsuGpu_3D(float *dev_o, float *dev_c, float *dev_n, float *dev_vel2Dtw2, int iGpu) {
