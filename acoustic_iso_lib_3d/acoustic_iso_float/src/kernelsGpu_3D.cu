...
__global__ void print_kernel(){
    int idx = threadIdx.x;
    printf("idx %d, value coeff %f\n", idx, dev_cosDampingCoeffGinsuConstant[1][idx]);
	// printf("idx %d, value nz = %d\n", idx, dev_nz_ginsu[iGpu]);
}
...
__global__ void interpFineToCoarseSlice_32_3D(float *dev_timeSliceLeft, float *dev_timeSliceRight, float *dev_timeSliceFine, int it2) {
...
__global__ void dampCosineEdge_32_3D(float *dev_p1, float *dev_p2) {
...
__global__ void dampCosineEdgeFreeSurface_32_3D(float *dev_p1, float *dev_p2) {
