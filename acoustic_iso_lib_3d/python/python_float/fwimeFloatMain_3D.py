...
if __name__ == '__main__':
	...
	dataFloat.getHyper().axes[1].o = 0.0
	...
	# h nonlinear
	hNonlinearDummyOp=pyOp.ZeroOp(modelFineInitFloatLocal,dataFloat)
	if client:
	...
	vpProb=Prblm.ProblemL2VpReg(modelInit,reflectivityExtInitLocal,vpOp,dataFloat,linSolver,gInvOp,h_op_reg=vpRegOp,epsilon=epsilon,minBound=minBoundVector,maxBound=maxBoundVector,prec=Precond)
