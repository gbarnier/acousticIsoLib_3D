...
PYBIND11_MODULE(pyAcoustic_iso_float_nl_3D, clsGeneric) {
  ...
  py::class_<deviceGpu_3D, std::shared_ptr<deviceGpu_3D>>(clsGeneric, "deviceGpu_3D")
      ...
      .def("getZCoord",(std::shared_ptr<float1DReg> (deviceGpu_3D::*)()) &deviceGpu_3D::getZCoord,"Function to get z-coordinates of acquisition device")

      .def("getXCoord",(std::shared_ptr<float1DReg> (deviceGpu_3D::*)()) &deviceGpu_3D::getXCoord,"Function to get x-coordinates of acquisition device")

      .def("getYCoord",(std::shared_ptr<float1DReg> (deviceGpu_3D::*)()) &deviceGpu_3D::getYCoord,"Function to get y-coordinates of acquisition device")
  ...
  py::class_<nonlinearPropShotsGpu_3D, std::shared_ptr<nonlinearPropShotsGpu_3D>>(clsGeneric,"nonlinearPropShotsGpu_3D")
      ...
      .def(py::init<std::shared_ptr<SEP::float3DReg>, std::shared_ptr<paramObj>, std::vector<std::shared_ptr<deviceGpu_3D>>, std::vector<std::shared_ptr<deviceGpu_3D>>, std::vector<std::shared_ptr<SEP::hypercube>>, std::shared_ptr<SEP::int1DReg>, std::shared_ptr<SEP::int1DReg>, std::vector<int>, std::vector<int>>(), "Initialize a nonlinearPropShotsGpu_3D with Ginsu")
