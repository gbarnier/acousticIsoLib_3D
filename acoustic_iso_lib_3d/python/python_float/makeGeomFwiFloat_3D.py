...
if __name__ == '__main__':
	...
	# First shot
	sourceGeomNp[0, 0] = 1.77 # x-position
	sourceGeomNp[1, 0] = 2.07 # y-position

	# Second shot
	sourceGeomNp[0, 1] = 2.07 # x-position
	sourceGeomNp[1, 1] = 2.07 # y-position

	# Third shot
	sourceGeomNp[0, 2] = 2.37 # x-position
	sourceGeomNp[1, 2] = 2.07 # y-position

	# Fourth shot
	sourceGeomNp[0, 3] = 2.67 # x-position
	sourceGeomNp[1, 3] = 2.07 # y-position

	# Fifth shot
	sourceGeomNp[0, 4] = 2.97 # x-position
	sourceGeomNp[1, 4] = 2.07 # y-position

	# Sixth shot
	sourceGeomNp[0, 5] = 3.27 # x-position
	sourceGeomNp[1, 5] = 2.07 # y-position
	...
	for iShot in range(nShot):
		print("y-position = ", 69.0 * dy)
		for iRec in range(nRec):
			# recGeomNp[0, :, iShot] = xPos.flatten()
			recGeomNp[0, iRec, iShot] = 0.0 + iRec * dx
			recGeomNp[1, iRec, iShot] = 69.0 * dy
