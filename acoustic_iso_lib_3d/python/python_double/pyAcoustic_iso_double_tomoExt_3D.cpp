...
PYBIND11_MODULE(pyAcoustic_iso_double_tomoExt_3D, clsGeneric) {
  ...
  py::class_<tomoExtShotsGpu_3D, std::shared_ptr<tomoExtShotsGpu_3D>>(clsGeneric,"tomoExtShotsGpu_3D")
      ...
      .def("setExtReflectivity_3D",(void (tomoExtShotsGpu_3D::*)(std::shared_ptr<double5DReg>)) &tomoExtShotsGpu_3D::setExtReflectivity_3D,"Function to set background velocity")
