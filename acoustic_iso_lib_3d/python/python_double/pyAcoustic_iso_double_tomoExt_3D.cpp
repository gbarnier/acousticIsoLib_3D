...
PYBIND11_MODULE(pyAcoustic_iso_double_tomoExt_3D, clsGeneric) {
  ...
  py::class_<tomoExtShotsGpu_3D, std::shared_ptr<tomoExtShotsGpu_3D>>(clsGeneric,"tomoExtShotsGpu_3D")
      ...
      // Ginsu constructor
      .def(py::init<std::shared_ptr<SEP::double3DReg>, std::shared_ptr<paramObj>, std::vector<std::shared_ptr<deviceGpu_3D>>, std::shared_ptr<double2DReg>, std::vector<std::shared_ptr<deviceGpu_3D>>, std::shared_ptr<double5DReg>, std::vector<std::shared_ptr<SEP::hypercube>>, std::shared_ptr<SEP::int1DReg>, std::shared_ptr<SEP::int1DReg>, int, int, std::vector<int>, std::vector<int>>(), "Initialize a tomoExtShotsGpu_3D")      
      ...
      .def("setExtReflectivity_3D",(void (tomoExtShotsGpu_3D::*)(std::shared_ptr<double3DReg>)) &tomoExtShotsGpu_3D::setExtReflectivity_3D,"Function to set background velocity")
