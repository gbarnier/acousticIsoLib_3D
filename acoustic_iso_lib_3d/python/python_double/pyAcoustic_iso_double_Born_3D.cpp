...
PYBIND11_MODULE(pyAcoustic_iso_double_Born_3D, clsGeneric) {
  ...
  py::class_<BornShotsGpu_3D, std::shared_ptr<BornShotsGpu_3D>>(clsGeneric,"BornShotsGpu_3D")
      ...
      // Normal constructor
      .def(py::init<std::shared_ptr<SEP::double3DReg>, std::shared_ptr<paramObj>, std::vector<std::shared_ptr<deviceGpu_3D>>, std::shared_ptr<SEP::double2DReg>, std::vector<std::shared_ptr<deviceGpu_3D>>, std::shared_ptr<wavefieldVector_3D>>(), "Initialize a BornShotsGpu_3D for FWIME")
      ...
      // Constructor for Ginsu
      .def(py::init<std::shared_ptr<SEP::double3DReg>, std::shared_ptr<paramObj>, std::vector<std::shared_ptr<deviceGpu_3D>>, std::shared_ptr<SEP::double2DReg>, std::vector<std::shared_ptr<deviceGpu_3D>>, std::vector<std::shared_ptr<SEP::hypercube>>, std::shared_ptr<SEP::int1DReg>, std::shared_ptr<SEP::int1DReg>, int, int, std::vector<int>, std::vector<int>, std::shared_ptr<wavefieldVector_3D>>(), "Initialize a BornShotsGpu_3D for FWIME with Ginsu")      
