...
if __name__ == '__main__':
	...
	# First shot
	sourceGeomNp[0, 0] = 0.5 # x-position
	sourceGeomNp[1, 0] = 0.5 # y-position

	# Second shot
	sourceGeomNp[0, 1] = 0.6 # x-position
	sourceGeomNp[1, 1] = 0.5 # y-position

	# Third shot
	sourceGeomNp[0, 2] = 0.8 # x-position
	sourceGeomNp[1, 2] = 0.4 # y-position

	# Fourth shot
	sourceGeomNp[0, 3] = 0.1 # x-position
	sourceGeomNp[1, 3] = 0.3 # y-position

	# Fifth shot
	sourceGeomNp[0, 4] = 0.4 # x-position
	sourceGeomNp[1, 4] = 0.5 # y-position
	...
	for iShot in range(nShot):
		xMaxBound = sourceGeomNp[0, iShot] + 0.1
		xMinBound = sourceGeomNp[0, iShot] - 0.1
		...
		# for iRec in range(nRec):
			...
			# xPos = sourceGeomNp[0, iShot] + linspace(-0.1, 0.1, 5)
			# yPos = random.uniform(oy, fy)
			# yPos = 0.1 + (iRec-1) * 0.01
